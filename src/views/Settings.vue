  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-xl p-6">
      ...
      <div class="space-y-3">
        <button 
          @click="exportData"
          class="w-full py-3 px-4 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-100 transition-colors text-left"
        >
        ...
        <button 
          @click="importData"
          class="w-full py-3 px-4 bg-green-50 text-green-600 rounded-xl hover:bg-green-100 transition-colors text-left"
        >
        ...
        <button 
          @click="clearAllData"
          class="w-full py-3 px-4 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition-colors text-left"
        >
